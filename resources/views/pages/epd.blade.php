...
<section class="global-page-header">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    <h2>ENTERPRISE & ANALYTIC PLATFORM DEVELOPMENT (EPD)</h2>
                </div>
            </div>
        </div>
    </div>
...
<section id="feature">
    <div class="container">
        <div class="section-heading">
            <h1 class="title wow fadeInDown" data-wow-delay=".3s">EPD</h1>
            <p class="wow fadeInDown" data-wow-delay=".5s">
                Enterprise & Analytic Platform Development (EPD) adalah ...
            </p>
        </div>
